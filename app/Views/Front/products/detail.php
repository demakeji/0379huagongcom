<div id="container" class="page-wrap">
    <div id="content" class="fr">
        <div class="crumb-nav">当前位置：<a href="index.html">首页</a><em>></em><a href="products.html">供货信息</a><em>></em><?= esc($title) ?></div>
        <div class="inner-main">
            <h3 class="title-bar"><strong class="fl">供货信息</strong><span class="fr"></span></h3>
            <div class="control-box pro-info">
                <div class="pro-img fl"><span><img width="250px" height="250px" src="<?= esc($image) ?>" alt="<?= esc($title) ?>" title="<?= esc($title) ?>"/></span></div>
                <div class="pro-summary fl">
                    ...
                    <ul>
                        ...
                        <li><strong>产&nbsp;&nbsp;地：</strong><?= esc($chandi) ?></li>
                    </ul>
                ...
                <div class="pro-details mt10">
                    ...
                    <dl class="description">
                        ...
                        <dd class="content f14"><?= esc($content) ?></dd>
                    </dl>
                </div>
            </div>
        </div>
