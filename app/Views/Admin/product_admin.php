...
<div class="container">
	...
	<script type="text/javascript" charset="utf-8" src="/websrc/include/ckeditor/ckeditor.js"></script>
    <form action="product_admin.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return checkform()">
    	<table width="96%" cellspacing="0" cellpadding="0" class="tb">
			...
			<tr id="prodcatesele">
    			...
    			<td>
    				...
    				{{foreach key=tk item=tp from=$prodcatelist}}
						<option value="{{$tp.Cid}}" {{if $tp.Cid==$one.Cid}}selected{{/if}}>{{$tp.Cname}}</option>
					{{/foreach}}
    				</select>
					<span class="tip"></span>
    			</td>
    		...
    		<tr>
    			...
    			<td>
    				<input type="text" name="Ptitle" id="Ptitle" size="36" value="{{$one.title}}" maxlength="24" />
					<span class="tip">长度在20个字以内</span>
    			</td>
    		</tr>
    		<tr>
    		...
    		<tr class="upimage" >
    			...
    			<td>
    				<iframe src="uploadimage.php?type=hproduct&path={{$upimgpath}}" frameborder="0" scrolling="no" width="680" height="120" ></iframe>
    			</td>
    		</tr>
    		<tr>
    			<td align="right"><strong>产品含量：</strong></td>
    			<td>
    				<input type="text" name="hanliang" id="Price" size="16" value="{{$one.hanliang}}" maxlength="15" />
    		...
    		<tr>
    			...
    			<td>
    				<input type="text" name="guige" id="Price" size="16" value="{{$one.guige}}" maxlength="15" />
					<span class="tip">填写数字，如3666.00</span>
    			</td>
    		</tr>
    		<tr>
    			...
    			<td>
    				<input type="text" name="Price" id="Price" size="16" value="{{$one.jiage}}" maxlength="15" />
					<span class="tip">填写数字，如3666.00</span>
    			</td>
    		</tr>
    		<!--<tr>
			...
			--><tr>
    			...
    			<td>
    				<input type="text" name="chandi" id="PsendArea" size="60" value="{{$one.chandi}}" maxlength="60" />
			...
			<tr>
    			...
    			<td>
					<textarea name="Pcontent" id="Pcontent" cols="80" rows="8" style="margin-bottom:10px" >{{$one.content}}</textarea><br />
					<script>
					//<![CDATA[
    		...
    		<tr>
    			...
    			<td>
					<br />
    				<input type="hidden" name="Hpid" value="{{$one.Hpid}}" />
